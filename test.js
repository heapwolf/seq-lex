...
assert(lexseq().charCodeAt(0) == 0, 'no args returns single char of ascii value 0');
...
assert(seq.length == 3, 'after iterating 255*3 the length of the value should be 3');
...
assert(seq[2].charCodeAt(0) == 254, 'the third character should be 254');
